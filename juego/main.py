...
mejores_5 = False
musica = True
pygame.mixer.music.load("C:\\Users\\usuario\\Downloads\\juego\\musica\\musica_halloween.mp3")
bandera_play = True
while bandera_play:
    ...
    for evento in lista_eventos:
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_s and menu_principal:
                if musica:
                    pygame.mixer.music.pause()  # Pausar la música si ya está sonando
                    musica = False
                else:
                    pygame.mixer.music.unpause()  # Continuar la reproducción si está pausada
                    musica = True
